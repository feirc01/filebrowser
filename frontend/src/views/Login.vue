  ...
  <div id="login" :class="{ recaptcha: recaptcha }">
    <f-background>
      <form @submit="submit">
        ...
        <input autofocus class="input input--block" type="text" autocapitalize="off" v-model="username"
          :placeholder="t('login.username')" />
        <input class="input input--block" type="password" v-model="password" :placeholder="t('login.password')" />
        <input class="input input--block" v-if="createMode" type="password" v-model="passwordConfirm"
...
import FBackground from "@/components/FBackground/index.vue"
